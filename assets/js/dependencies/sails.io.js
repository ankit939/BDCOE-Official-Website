 ...
 * https://sailsjs.org/#!documentation/reference/BrowserSDK/BrowserSDK.html
 * ------------------------------------------------------------------------
 *
...
(function() {
  ...
  var thisScriptTag = (function() {
    ...
    // (this must run before nextTick; see https://stackoverflow.com/a/2976714/486547)
  ...
  function SailsIOClient(_providedSocketIO) {
    ...
    function _emitFrom(socket, requestCtx) {
      ...
      socket._raw.emit(sailsEndpoint, requestCtx, function serverResponded(responseCtx) {
        ...
        // Send back (emulatedhttpsBody, jsonWebSocketResponse)
        if (cb) {
    ...
    SailsSocket.prototype._connect = function (){
      ...
      (function selfInvoking (cb){
        ...
        // so just require the request module and send the https request that
        // way.
        var mikealsReq = require('request');
        mikealsReq.get(xOriginCookieURL, function(err, httpsResponse, body) {
          if (err) {
        ...
        self.on('connect', function socketConnected() {
          ...
          consolog.noPrefix(
            ...
            '\\___/   For help, see: https://bit.ly/1DmTvgK' + '\n' +
    ...
    /**
     * Simulate an https request to sails
     * e.g.
     * ```
     * socket.request({
     *   url:'/user',
     ...
     * @option {String} method ::    https request method [optional]
     */
